...
struct ShortcutSettingsView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text(language.text("Hold and release to submit. Double-tap for Hands-free Dictation, then tap to finish. Plain Esc cancels.", "按住说话，松开提交。双击开始免按键听写，再轻按结束。单独 Esc 用于取消。"))
