...
@MainActor final class WhisperAppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate {
    ...
    @objc private func showAbout() {
        ...
        NSApplication.shared.orderFrontStandardAboutPanel(options: [
            ...
            .credits: NSAttributedString(string: language.text(
                "MediaRemoteAdapter: MIT. FFmpeg: LGPL 2.1 or later. LAME: LGPL 2.0 or later. See Third-party licenses for full notices.",
                "MediaRemoteAdapter：MIT。FFmpeg：LGPL 2.1 或更高版本。LAME：LGPL 2.0 或更高版本。完整声明请见第三方许可证。"
            ))
        ])
    }
    ...
    func applicationShouldTerminate(_ sender: NSApplication) -> NSApplication.TerminateReply {
        ...
        Task { @MainActor in
            ...
            // The integrated History owner must also await flushHistoryWrites before this reply.
