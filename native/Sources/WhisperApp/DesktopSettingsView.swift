...
enum DesktopSettingsGroup: CaseIterable { case appearance, sound, floating, startup }

struct DesktopSettingsView: View {
    let application: WhisperApplication
    var groups: Set<DesktopSettingsGroup> = Set(DesktopSettingsGroup.allCases)
