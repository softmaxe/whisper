...
- Keep GitHub configuration limited to this fork's build, release, and Homebrew tap workflows. Leave Wiki disabled and community templates, contribution policies, CodeQL, and lockfile-lint automation unconfigured unless requested. Keep application security documentation under `docs/`.
